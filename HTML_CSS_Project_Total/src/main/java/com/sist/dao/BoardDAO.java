...
public class BoardDAO {
	...
	public List<BoardVO> boardListData(int page)
	{
		...
		try {
			...
			String sql = "SELECT no,subject,name,TO_CHAR(regdate,'YYYY-MM-DD'),hit,num "
						...
						+"FROM (SELECT /*+ INDEX_DESC(board board_no_pk)*/no,subjeect,name,regdate,hit "
						+"FROM board))"
			...
			System.out.println("====BoardListData(int page) 오류 ====");
			ex.printStackTrace();
		}
		finally {
	...
	public int boardTotalPage()
	{
		...
		try {
			...
			System.out.println("==== boardTotlaPage() 오류 발생 ======");
			ex.printStackTrace();}
		finally {
			dbConn.disConnection(conn, ps);
		}
