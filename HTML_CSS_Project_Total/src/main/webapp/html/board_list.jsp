...
<%
   	// 사용자가 보내준 값을 받는다 => 페이지 => request.getParameter <값 받을 때 사용
    ...
    BoardDAO dao = BoardDAO.newInstance();
   	...
   	int totaloage=(int)(Math.ceil(count/10.0));
...
<body>
	<div class="container">
	  ...
	  <div class="row">
	   <table class="table table-striped">
	    	<tr>
	    	 ...
	    	 %>
	    	 	<tr>
	    	  		<td width="10%" class="text-left"><%=count-- %></td> 
	    	  		<td width="45%">
	 ...
	 <td class="text-left">
	  ...
	  <td class="text-right">
	  	<a href="board_list.jps?page=<%=curpage>1?curpage-1:curpage %>" class="btn btn-sm btn-primary">이전</a>
	  <%=curpage %> page / <%=totalpage %> pages
	  	<a href="<%=curpage<totalpage?curpage+1:curpage %>" class="btn btn-sm btn-primary">다음</a>
	 </div>
	</div>
</body>
</html>