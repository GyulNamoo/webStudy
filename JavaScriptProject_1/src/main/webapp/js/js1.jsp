...
<%--
	  자바스크립트 : 브라우저 자체에서 처리 (서버처리가 아니다)
	        ...
	        ==================================
	        2) 자바스크립트 => 화면에 대한 동적 처리 => 오라클 연결이 가능 (서버축 사이트 => NodeJS)
	              ...
	              2. 버전
	                 ...
	                 ES6
	                   ...
	                   => 예)
	                    ...
	                    같다( ==  ==> ===) rudrh (VueJS/ReactJS => 반드시 === )
	                    => 문장이 종료될 때 (예전: ; => 최신에는 ;을 사용하지 않는다 => 들여쓰기 )
	                    													 =======================
	                    													 1. 코틀린, 파이썬, 스칼라 ...  
	        ...
	        ================================== Back-End
	  1. 변수 설정
	     = 데이터형을 사용하지 않는다 / 자동 지정 변수 사용 / 전역변수 , 지역변수 사용이 가능 
	       <script type="">
	        변수 선언 => 전역변수
	        function aaa()
	        {
 ...
 */
 window.onload=function(){
	 		...
	 		document.write(e+":"+typeof e+"<br>") // object
	 		document.write(f+":"+typeof f+"<br>") // objectㄴ
