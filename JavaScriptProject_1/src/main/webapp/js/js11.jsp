...
window.onload=()=>{
	const sawon=[{"sabun":1,"name":"홍길동","sex":"남자","dept":"개발부","loc":"서울"},
					   	 {"sabun":2,"name":"이순신","sex":"없음","dept":"영업부","loc":"부산"},
							 {"sabun":3,"name":"박문수","sex":"남자","dept":"총무부","loc":"경기"},
							 {"sabun":4,"name":"심청이","sex":"남자","dept":"자재부","loc":"강원"},
							 {"sabun":5,"name":"강감찬","sex":"여자","dept":"인사부","loc":"제주"}
		] // SawonVO 키:값 
	// JSON => 자바스크립트 객체 표현법 
	/*
