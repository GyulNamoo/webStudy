			...
			<table class="table">
							...
							<table class="table">
								<tr>
									<td width="30%" class="text-center" rowspan="2">
										<img src="${vo.poster }" style="width:100%; height: 100px" class="img-circle">
									</td>
									<td colspan="4">
				...
				<tr>
					<td class="text-center">
						<a href="../recipe/chef_list.do?page=${curpage>1?curpage-1:curpage }" class
						<a href="../recipe/chef_list.do?page=${curpage }
					</td>
				</tr>
			</table>
		</main>
