...
public class EmpDAO {
	 ...
	 *    ==========================================
	 * 	
	 * 	  JDBC => DBCP => ORN (MyBatis) => DataSet (JPA) 
	 *           =====
	 *           1. WEB에서만 사용이 가능 
	 */
