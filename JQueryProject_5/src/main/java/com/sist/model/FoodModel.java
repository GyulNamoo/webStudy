...
public class FoodModel {
	private String[] strType= {"","한식","중식","양식","일식"};
	...
	public void food2_food(HttpServletRequest request, HttpServletResponse response) //Ajax<< void로
	{
		String page = request.getParameter("page");
		if(page==null)
			page="1";
		...
		try
		{
			...
			for(FoodVO vo:list)
			{
				JSONObject obj = new JSONObject(); // 자바스크립트 객체 생성 방식
