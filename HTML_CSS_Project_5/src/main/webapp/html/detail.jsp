...
<%
	// 데이터 가지고 오기
	// 1. 사용자가 보내준 값을 받는다 =>
	//http://http://localhost:8080/HTML_CSS_Project_5/html/detail.jsp?no=29
	//																  ===== 사용자가 전송한 값
	...
	<table class="table_content" width="800">
		...
		<tr>
			<td width="60%">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span id="del">1,595원</span><span></span>적립 (모든 회원 구매액의 0.5% 적립)</span>
			</td>
		</tr>
		<tr>
			<td width="60%">
