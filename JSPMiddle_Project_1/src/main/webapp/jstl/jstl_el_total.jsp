...
<%--
	 ...
	 EL => ${값}
	        === 일반 데이터 사용이 가능 (자바 변수는 출력할 수 없다)
	            ...
	            => request의 키와 session의 키가 동일할 때 request가 우선순위 
	            => param / paramValues
	                        | request.getParameterValues()
	                | request.getParameter()
	                => 사용빈도가 거의 없다
	       JSP ===> 요청 ===> Java ===> 요청처리 ====> JSP
	                                          request/session에 결과값을 달아서 넘겨준다
	                                          				    =================
	                                          				    setAttribute()
	                                          				       |
	                                          				       ${}
	       연산자
	         ...
	         JSTL : Tag로 자바 문법 사항을 만들었다 
	                ==== 제어문 , 화면 이동 , 변수선언, 날짜변환, 숫자변환(format), String메소드 제어(function)
	                     ======================  ============================
	                                               자바에서 주로 처리 => 결과값
	                               | core
      ...
      => Spring Framework / Java / Mybatis ******* => VueJS
