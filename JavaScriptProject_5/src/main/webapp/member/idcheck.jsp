...
<script type="text/javascript">
	function idcheck()
	{
		let id=document.querySelecotr("#id")
		if(id.value.trim()==="")
			{
					// 입력이 안된 상태
					alert("ID를 입력하세요!!")
				...
				if(count===0)
					{
						...
						span.InnerHTML='<font colot="blue">'+id.value+'는(은) 사용 가능한 아이디입니다</font>'
					...
					{
						let span=document.querySelector("#result")
						span.InnerHTML='<font colot="red">'+id.value+'는(은) 이미 사용중인 아이디입니다</font>'
					}
			...
			<div class="row">
				<table class="table">
					<tr>
						...
						<input type=button value="중복체크" class="btn-sm btn-danger" id=idcheck()>
						</td>
					</tr>
					<tr>
