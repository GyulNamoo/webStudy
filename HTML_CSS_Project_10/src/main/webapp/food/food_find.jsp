<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%
 	/*
 		http://localhost:8080/HTML_CSS_Project_10/food/food_find.jsp
 		 => addr==null
 		http://localhost:8080/HTML_CSS_Project_10/food/food_find.jsp?addr=
 		 => addr=""
 	*/
 	//브라우저 : 1byte => 자바 : 2byte =>decoding
 	request.setCharacterEncoding("UTF-8"); // request.getPararmeter() 전에 설정
 	// 한글 변환 코드
 	...
 	/*
 	http://localhost:8080/HTML_CSS_Project_10/food/food_find.jsp?addr=%EC%84%9C%EB%8C%80%EB%AC%B8
	...
	<div style="height: 20px"></div>
	 <div class="row">
		...
		<div class="col-sm-3">
			<a href="#">
			 <div class="thumbnail">
			  <img src="<%=vo.getPoster() %>" style="width: 240px; heigth:240px" class="img-rounded">
