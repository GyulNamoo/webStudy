			...
			JSP사용 
			  ...
			  내장객체 
			  		HttpServletRequest => request
			  		  = 브라우저 정보
			  		  	http://localhost:8080/JSPBasic_Project_13/jsp/total.jsp
			  		  	======================================================= URL
			  		  	===== protocol       ================================== URI
			  		  	      =============== ================== ContextPath
			  		  	      서버 ID
			  		    ...
			  		    2) getContextPath()
			  		    3) getRequestURL()
			  		    4) getRemoteAddr() : 사용자의 IP를 얻어 온다
			  		  = 사용자 요청정보
			  		    1) getParameter() : 사용자 보내준 단일 데이터 값
			  		...
			  		HttpServlertResponse => response => 응답
			  		  = 헤더 정보 : 다운로드 => 실제 데이터 전송전에 먼저 보내는 값  
			  		    setHeader()
			  		  = 이동정보
			  		...
			  		기타 : Cookie => 사용자 브라우저에 젖아 (문자열만 저장이 가능)
			  		     1. 생성
